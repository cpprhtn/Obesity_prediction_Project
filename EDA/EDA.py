...
b_08.to_csv('b_08.csv', index=False)
s_08.to_csv('s_08.csv', index=False)





busan_09 = pd.read_csv('busan_09.csv',  encoding = 'cp949')
seoul_09 = pd.read_csv('seoul_09.csv',  encoding = 'cp949')
# 경제활동여부 없음
b_09 = busan_09[['bogun_cd','apt_t','fma_19z1','fma_04z1','fma_12z1','sma_03z2','drb_01z2',
                 'age','sex','phb_01z1','nub_01z1','oba_01z1','obb_01z1','oba_02z1',
                 'oba_03z1','mta_01z1','mtb_01z1','mtd_01z1','hya_04z1','dia_05z1',
                 'sod_02z1']]
s_09 = seoul_09[['bogun_cd','apt_t','fma_19z1','fma_04z1','fma_12z1','sma_03z2','drb_01z2',
                 'age','sex','phb_01z1','nub_01z1','oba_01z1','obb_01z1','oba_02z1',
                 'oba_03z1','mta_01z1','mtb_01z1','mtd_01z1','hya_04z1','dia_05z1',
                 'sod_02z1']]
...
b_09.to_csv('b_09.csv', index=False)
s_09.to_csv('s_09.csv', index=False)
...
# 
b_10 = busan_10[['bogun_cd','apt_t','fma_19z1','fma_04z1','fma_12z1','sma_03z2','drb_01z2',
                 'age','sex','phb_01z1','nub_01z1','oba_01z1','obb_01z1','oba_02z1',
                 'oba_03z1','mta_01z1','mtb_01z1','mtd_01z1','hya_04z1','dia_04z1',
                 'sod_02z1']]
s_10 = seoul_10[['bogun_cd','apt_t','fma_19z1','fma_04z1','fma_12z1','sma_03z2','drb_01z2',
                 'age','sex','phb_01z1','nub_01z1','oba_01z1','obb_01z1','oba_02z1',
                 'oba_03z1','mta_01z1','mtb_01z1','mtd_01z1','hya_04z1','dia_04z1',
                 'sod_02z1']]
